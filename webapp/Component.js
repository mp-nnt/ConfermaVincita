sap.ui.define([
	...
	"sap/ui/Device",
	"com/pabz/ConfermaVincita/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("com.pabz.ConfermaVincita.Component", {
		...
		/*
				completeTask: function (approvalStatus) {
					...
					oModel.setProperty("/winner", approvalStatus);

					$.ajax({
						url: "/bpmworkflowruntime/rest/v1/task-instances/" + this.taskId,
						method: "PATCH",
